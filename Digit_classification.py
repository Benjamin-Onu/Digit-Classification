...
def cross_entropy_loss(y_true, y_pred):
    #Return cross entropy average loss based on the above formula
    epsilon = 1e-12
...
# learning_rate = #Initalize your learning rater here
...
# plot accuracies for each learning rate
...
#Apply softmax
print("Test accuracy:", accuracy(test_labels, test_predictions))
#==================================================================#    
